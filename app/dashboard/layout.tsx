...
export default function DashboardLayout({
    ...
    const getBrigada = (fecha: Date) => {
        ...
        const bases = [
            { nombre: "B1", color: "bg-[#D32F2F]" },
            { nombre: "B2", color: "bg-[#1976D2]" },
            { nombre: "B3", color: "bg-[#388E3C]" },
            { nombre: "B4", color: "bg-[#F57C00]" }
        ];
    ...
    return (
        <div className="flex h-screen bg-[#F8F9FA] font-sans overflow-hidden">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col items-center py-10 px-6 shrink-0 z-10 overflow-y-auto">
                <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden border-4 border-white shadow-md cursor-pointer" onClick={() => router.push('/dashboard')}>
                    <img src="/logo.jpg" alt="Perfil" className="w-full h-full object-cover hover:scale-105 transition" />
                </div>
